...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReceiptMerchantDataMerchantProfile', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.ReceiptMerchantDataMerchantProfile();
      });

      it('should create an instance of ReceiptMerchantDataMerchantProfile', function() {
        // TODO: update the code to test ReceiptMerchantDataMerchantProfile
        expect(instance).to.be.a(SumUpRestApi.ReceiptMerchantDataMerchantProfile);
      });
