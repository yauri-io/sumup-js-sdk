...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PersonalDetailsResponse', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.PersonalDetailsResponse();
      });

      it('should create an instance of PersonalDetailsResponse', function() {
        // TODO: update the code to test PersonalDetailsResponse
        expect(instance).to.be.a(SumUpRestApi.PersonalDetailsResponse);
      });
