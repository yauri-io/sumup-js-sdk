...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckoutSuccess', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.CheckoutSuccess();
      });

      it('should create an instance of CheckoutSuccess', function() {
        // TODO: update the code to test CheckoutSuccess
        expect(instance).to.be.a(SumUpRestApi.CheckoutSuccess);
      });
