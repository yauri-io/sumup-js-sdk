...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PersonalProfile', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.PersonalProfile();
      });

      it('should create an instance of PersonalProfile', function() {
        // TODO: update the code to test PersonalProfile
        expect(instance).to.be.a(SumUpRestApi.PersonalProfile);
      });
