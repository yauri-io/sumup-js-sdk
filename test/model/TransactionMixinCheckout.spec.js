...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionMixinCheckout', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.TransactionMixinCheckout();
      });

      it('should create an instance of TransactionMixinCheckout', function() {
        // TODO: update the code to test TransactionMixinCheckout
        expect(instance).to.be.a(SumUpRestApi.TransactionMixinCheckout);
      });
