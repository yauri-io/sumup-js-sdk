...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfinlineResponse2001TransactionsItems', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.AllOfinlineResponse2001TransactionsItems();
      });

      it('should create an instance of AllOfinlineResponse2001TransactionsItems', function() {
        // TODO: update the code to test AllOfinlineResponse2001TransactionsItems
        expect(instance).to.be.a(SumUpRestApi.AllOfinlineResponse2001TransactionsItems);
      });
