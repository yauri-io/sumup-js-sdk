...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfCheckoutTransactionsItems', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.AllOfCheckoutTransactionsItems();
      });

      it('should create an instance of AllOfCheckoutTransactionsItems', function() {
        // TODO: update the code to test AllOfCheckoutTransactionsItems
        expect(instance).to.be.a(SumUpRestApi.AllOfCheckoutTransactionsItems);
      });
