...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckoutSuccessToken', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.CheckoutSuccessToken();
      });

      it('should create an instance of CheckoutSuccessToken', function() {
        // TODO: update the code to test CheckoutSuccessToken
        expect(instance).to.be.a(SumUpRestApi.CheckoutSuccessToken);
      });
      ...
      it('should have the property paymentInstrument (base name: "payment_instrument")', function() {
        // TODO: update the code to test the property paymentInstrument
        expect(instance).to.have.property('paymentInstrument');
        // expect(instance.paymentInstrument).to.be(expectedValueLiteral);
      });
