...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckoutCreateRequestPersonalDetailsAddress', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.CheckoutCreateRequestPersonalDetailsAddress();
      });

      it('should create an instance of CheckoutCreateRequestPersonalDetailsAddress', function() {
        // TODO: update the code to test CheckoutCreateRequestPersonalDetailsAddress
        expect(instance).to.be.a(SumUpRestApi.CheckoutCreateRequestPersonalDetailsAddress);
      });
