...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddressPayload', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.AddressPayload();
      });

      it('should create an instance of AddressPayload', function() {
        // TODO: update the code to test AddressPayload
        expect(instance).to.be.a(SumUpRestApi.AddressPayload);
      });
