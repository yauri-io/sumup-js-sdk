...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfCheckoutCreateRequestTransactionsItems', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.AllOfCheckoutCreateRequestTransactionsItems();
      });

      it('should create an instance of AllOfCheckoutCreateRequestTransactionsItems', function() {
        // TODO: update the code to test AllOfCheckoutCreateRequestTransactionsItems
        expect(instance).to.be.a(SumUpRestApi.AllOfCheckoutCreateRequestTransactionsItems);
      });
