...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckoutCreate', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.CheckoutCreate();
      });

      it('should create an instance of CheckoutCreate', function() {
        // TODO: update the code to test CheckoutCreate
        expect(instance).to.be.a(SumUpRestApi.CheckoutCreate);
      });
