...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CheckoutCreateRequest', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.CheckoutCreateRequest();
      });

      it('should create an instance of CheckoutCreateRequest', function() {
        // TODO: update the code to test CheckoutCreateRequest
        expect(instance).to.be.a(SumUpRestApi.CheckoutCreateRequest);
      });
