...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MerchantProfilePayload', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.MerchantProfilePayload();
      });

      it('should create an instance of MerchantProfilePayload', function() {
        // TODO: update the code to test MerchantProfilePayload
        expect(instance).to.be.a(SumUpRestApi.MerchantProfilePayload);
      });

      it('should have the property legalTypeId (base name: "legal_type_id")', function() {
        // TODO: update the code to test the property legalTypeId
        expect(instance).to.have.property('legalTypeId');
        // expect(instance.legalTypeId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property isTestAccount (base name: "is_test_account")', function() {
        // TODO: update the code to test the property isTestAccount
        expect(instance).to.have.property('isTestAccount');
        // expect(instance.isTestAccount).to.be(expectedValueLiteral);
      });
