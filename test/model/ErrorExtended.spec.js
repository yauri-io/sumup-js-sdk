...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorExtended', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.ErrorExtended();
      });

      it('should create an instance of ErrorExtended', function() {
        // TODO: update the code to test ErrorExtended
        expect(instance).to.be.a(SumUpRestApi.ErrorExtended);
      });
