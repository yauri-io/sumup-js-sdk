...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VatRates', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.VatRates();
      });

      it('should create an instance of VatRates', function() {
        // TODO: update the code to test VatRates
        expect(instance).to.be.a(SumUpRestApi.VatRates);
      });
      ...
      it('should have the property ordering (base name: "ordering")', function() {
        // TODO: update the code to test the property ordering
        expect(instance).to.have.property('ordering');
        // expect(instance.ordering).to.be(expectedValueLiteral);
      });
