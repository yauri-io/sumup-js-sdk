...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MerchantProfilePayloadDoingBusinessAs', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.MerchantProfilePayloadDoingBusinessAs();
      });

      it('should create an instance of MerchantProfilePayloadDoingBusinessAs', function() {
        // TODO: update the code to test MerchantProfilePayloadDoingBusinessAs
        expect(instance).to.be.a(SumUpRestApi.MerchantProfilePayloadDoingBusinessAs);
      });
