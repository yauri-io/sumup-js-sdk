...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfCheckoutSuccessTokenTransactionsItems', function() {
      beforeEach(function() {
        instance = new SumUpRestApi.AllOfCheckoutSuccessTokenTransactionsItems();
      });

      it('should create an instance of AllOfCheckoutSuccessTokenTransactionsItems', function() {
        // TODO: update the code to test AllOfCheckoutSuccessTokenTransactionsItems
        expect(instance).to.be.a(SumUpRestApi.AllOfCheckoutSuccessTokenTransactionsItems);
      });
