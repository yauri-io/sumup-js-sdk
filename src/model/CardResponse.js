 ...
 * @member {module:model/CardResponse.ExpiryMonthEnum} expiryMonth
 */
CardResponse.prototype.expiryMonth = undefined;

/**
 * Three-digit card verification value (security code) of the payment card.
 * @member {String} cvv
 */
CardResponse.prototype.cvv = undefined;

/**
 * Required five-digit ZIP code. Applicable only to merchant users in the USA.
 * @member {String} zipCode
 */
CardResponse.prototype.zipCode = undefined;

/**
 * Last 4 digits of the payment card number.
 * @member {String} last4Digits
 */
CardResponse.prototype.last4Digits = undefined;
 ...
 * @member {module:model/CardResponse.TypeEnum} type
 */
CardResponse.prototype.type = undefined;
